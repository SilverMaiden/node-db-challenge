...
Relational Databases are a system, while SQL is a language used to interact with the system.

- [ ] Why do tables need a `primary key`?
We need them to make sure each data entry in a column is unique.
